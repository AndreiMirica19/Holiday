...
public class FavAdapter extends RecyclerView.Adapter<FavAdapter.FavHolder> {
    ...
    public FavAdapter( OnTripListener monTripListener) {
    ...
    public FavHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new FavHolder(itemView,monTripListener);
    }
    ...
    public  void SetTrips(List<Trips>trips){
        for(Trips trips1:trips){
            if(trips1.getBookmark()){
                this.trips.add(trips1);
            }
        }
    ...
    class FavHolder extends RecyclerView.ViewHolder implements View.OnClickListener   {
        ...
        @SuppressLint("ResourceAsColor")
        public FavHolder(@NonNull View itemView, OnTripListener onTripListener) {
            super(itemView);
