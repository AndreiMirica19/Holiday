package com.example.holiday.ui.FavList;
...
import com.example.holiday.ui.FavAdapter;
import com.example.holiday.ui.TripAdapter;
import com.example.holiday.ui.home.HomeViewModel;
...
public class FavFragment extends Fragment implements FavAdapter.OnTripListener {


    //public static TripViewModel tripViewModel;
    final public FavAdapter adapter1=new FavAdapter(this);
    public View onCreateView(@NonNull LayoutInflater inflater,
                             ViewGroup container, Bundle savedInstanceState) {

        View root = inflater.inflate(R.layout.fragment_favorite, container, false);
        RecyclerView recyclerView =(RecyclerView) root.findViewById(R.id.recycleView1);
        RecyclerView.LayoutManager layoutManager=new LinearLayoutManager(getActivity());
        recyclerView.setLayoutManager(layoutManager);


        recyclerView.setAdapter(adapter1);
      MainActivity.BookmarkViewModel.getAllTrips().observe((LifecycleOwner) getContext(), new Observer<List<Trips>>() {
            @Override
            public void onChanged(List<Trips> tripss) {
                adapter1.SetTrips(tripss);
        ...
        new ItemTouchHelper(new ItemTouchHelper.SimpleCallback(0,
            ...
            public void onSwiped(@NonNull RecyclerView.ViewHolder viewHolder, int direction) {
                MainActivity.tripViewModel.delete(adapter1.getTripAt(viewHolder.getAdapterPosition()));
            }
